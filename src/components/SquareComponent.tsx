...
export default function SquareComponent(props: Components) {
    ...
    return (
        <>
            ...
            <Rnd 
                className="textComponent" default={{ x: position.x, y: position.y, width: dimension.width, height: dimension.height }} 
